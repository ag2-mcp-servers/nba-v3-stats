...
from models import (
    BoxScore,
    FieldFormatAllStarsSeasonGetResponse,
...
@app.get(
    ...
    tags=['player_statistics', 'season_overview'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
)
def all_stars(format: Format = 'XML', season: str = ...):
    """
    All-Stars
    """
...
@app.get(
    '/{format}/AllTeams',
    tags=['team_statistics', 'season_overview', 'player_roster_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['game_details', 'season_overview'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    '/{format}/FreeAgents',
    tags=['player_roster_management', 'player_statistics'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['media_updates', 'player_statistics'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['player_statistics', 'player_roster_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['player_statistics', 'game_details'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_statistics', 'season_overview'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_statistics', 'player_roster_management'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['season_overview', 'team_statistics'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_statistics', 'game_details'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
